...
pub const LOOK_AHEAD_START_DRAW: (f32, f32) = (LOOK_AHEAD_POSITION.0 - LOOK_AHEAD_WIDTH*0.7, LOOK_AHEAD_POSITION.1 + LOOK_AHEAD_HEIGHT/4.0);
pub const LOOK_AHEAD_NEXT_PIECE_OFFSET: f32 = LOOK_AHEAD_SQUARE_SIZE*5.0 + LOOK_AHEAD_SQUARE_SIZE;
